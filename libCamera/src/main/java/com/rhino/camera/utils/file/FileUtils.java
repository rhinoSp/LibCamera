package com.rhino.camera.utils.file;
...
public class FileUtils {
    ...
    public static String createBitmapFileName() {
        return System.currentTimeMillis() + PICTURE_FORMAT;
    }
    ...
    public static String createVideoFileName() {
        return System.currentTimeMillis() + VIDEO_FORMAT;
    }
     ...
     * @return
     */
    public static String mergeMultipleVideoFile(Context context, String videoPath1, String videoPath2, final String outPutDirectoryPath) {
        Log.i(VideoRecordOperator.TAG, " 需要合并的两个文件 " + videoPath1 + " 和 " + videoPath2);
        String currentFileName = new File(outPutDirectoryPath, createVideoFileName()).getAbsolutePath();
        try {
            //将视频文件转成对应的Movie
