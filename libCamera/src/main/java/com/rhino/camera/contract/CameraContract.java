package com.rhino.camera.contract;
...
public interface CameraContract {
    ...
    interface Presenter {
         ...
         * @param direction
         */
        void switchCamera1(int direction);
        ...
        /**
         * 设置视频输出目录
         * @param directoryPath 视频输出目录
         */
        void setCameraVideoOutputDirectory(String directoryPath);

        /**
         * 设置音频输出目录
         * @param directoryPath 音频输出目录
         */
        void setCameraPictureOutputDirectory(String directoryPath);
    }
