...
import com.rhino.camera.camera2.compare.CompareSizeByArea;
...
public class PictureOperater extends BaseCamera2Operator {
    ...
    public void writePictureData(Image image) {
        if (camera2ResultCallBack != null) {
            camera2ResultCallBack.callBack(ObservableBuilder.createWriteCaptureImage(appContext, image, outPutDirectoryPath));
        }
    }
